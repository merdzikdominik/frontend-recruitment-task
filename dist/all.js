...
`;class Overlay extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(template.content.cloneNode(!0))}overlayBackdropClose(){document.querySelector("overlay-window");const e=this.shadowRoot.querySelector(".overlay-container__backdrop");e.addEventListener("click",overlayCloseHandler)}connectedCallback(){this.overlayBackdropClose()}}export default Overlay;import ContentLoader from"./ContentLoader.js";import CustomButton from"./CustomButton.js";import Message from"./Message.js";import Overlay from"./Overlay.js";window.customElements.define("content-loader",ContentLoader),window.customElements.define("custom-button",CustomButton),window.customElements.define("message-box",Message),window.customElements.define("overlay-window",Overlay);const incrementHandler=()=>{var e=localStorage.getItem("counter");localStorage.setItem("counter",++e)},resetCountsHandler=()=>{localStorage.setItem("counter",0)},overlayInitHandler=()=>{var e=document.createElement("overlay-window");document.body.prepend(e)},overlayCloseHandler=()=>{var e=document.querySelector("overlay-window");document.body.removeChild(e)};export{incrementHandler,resetCountsHandler,overlayInitHandler,overlayCloseHandler};